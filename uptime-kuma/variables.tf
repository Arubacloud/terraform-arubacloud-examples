...
variable "vm_flavor"      { type = string; default = "CSO1A2";       description = "CloudServer flavor." }
variable "vm_image"       { type = string; default = "LU22-001";     description = "Boot image (Ubuntu 22.04)." }
...
variable "ssh_cidr"     { type = string; default = "0.0.0.0/0"; description = "CIDR for SSH — restrict to your IP." }
variable "admin_cidr"   { type = string; default = "0.0.0.0/0"; description = "CIDR for Uptime Kuma web UI (port 3001). Restrict to your IP." }
variable "kuma_port"    { type = number; default = 3001;         description = "Port Uptime Kuma listens on." }
