...
variable "app_name" {
  description = "Short application name used as part of all resource names (e.g. 'ghost')."
  type        = string
  default     = "ghost"
...
variable "vm_flavor" {
  description = "CloudServer flavor name. CSO2A4 (2 vCPU / 4 GB) is the recommended minimum for Ghost."
  type        = string
  default     = "CSO2A4"
}
